...
class DHMCSampler(object):
    ...
    def gauss_laplace_leapfrog(self, f, f_update, dt, theta0, p0, logp, grad,aux, n_disc=0, M=None):
        """
    ...
    def integrator(self, dt, theta0, p0, logp, grad, aux):
        return self.gauss_laplace_leapfrog(self.f, self.f_update, dt, theta0, p0, logp, grad, aux, self.n_disc, self.M)
